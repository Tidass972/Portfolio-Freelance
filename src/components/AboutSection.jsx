...
export default function AboutSection() {
    return (<section id="about" className="py-40 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl group">
            <Image src="/images/Codeur.jpg" alt="David Debarieux - Développeur Web Front-end" fill className="object-cover group-hover:scale-110 transition-transform duration-700 ease-in-out" priority quality={100} sizes="(max-width: 768px) 100vw, 50vw"/>
