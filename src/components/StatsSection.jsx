...
const stats = [
    {
        ...
        description: "Applications web et mobiles déployées"
    },
    {
        value: "98%",
    ...
    },
    {
        value: "50k+",
        label: "Utilisateurs",
        description: "Utilisateurs actifs sur mes applications"
    },
    {
        value: "5",
...
export function StatsSection() {
    return (<section id="stats" className="py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
      <div className="container">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {stats.map((stat, i) => (<motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2 }} viewport={{ once: true }}>
